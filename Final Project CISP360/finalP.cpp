        ...
        switch (choice) {
            ...
            case 2:                  // Display how to play instructions upon typing 2.             
                cout << "How to Play: \n"
                     ...
                     << "3. Combat is automated and completely random.\n"
                     << "4. Good Luck in there!!\n"
                     << "\n";
...
void underttlINTRO() {
    ...
    cout << "**************************************************************************************************\n"
         ...
         << "* The docking onto a Derilict Ship is currently taking place. You are facing the airlock panel.  *\n"
         << "*                                                                                                *\n"
         << "*      > The door to the Derilict Ship has been opened.                                          *\n"
         << "**************************************************************************************************\n"
         << "* As the door to airlock slowly glides open. You walk forward. Steam starts to fill the zone     *\n"
         ...
         << "* I?..... you ask yourself. As you slowly awake and return to your feet. You notice multiple     *\n"
         << "* doors. One in front of you, behind you and on both sides. This looks a hanger of some kind?    *\n"
         << "**************************************************************************************************\n";
}
...
void gameLOOP() {
    ...
    zones[0] = {"ENTRANCE [Hanger]", "You are in a dimly lit aircraft hanger.\n", true, 0, {'N', 'S', 'E', 'W'}, {"SPACE MARINE", "A menacing combatant of the Cabal.\n", 50, 10}};
    zones[1] = {"[MAIN SHIP HALLWAY]", "This place feels rather creepy and quiet.... to quiet.....\n", false, 1, {'N', 'S', 'E', 'W'}, {"", "", 0, 0}};
